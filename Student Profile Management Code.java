...
class Frame2 extends JFrame
{
      ...
      b1.addActionListener(new ActionListener()
      {
            public void actionPerformed(ActionEvent ae)
            {
                  ...
                  {
          			JOptionPane.showMessageDialog(Frame2.this,"Please Enter USERNAME","ALERT",JOptionPane.ERROR_MESSAGE); 
                        return;
                  }
		      else if(t2.getText().equals(""))
		      {
                        JOptionPane.showMessageDialog(Frame2.this,"Please Enter PASSWORD","ALERT",JOptionPane.ERROR_MESSAGE);
                        return;
                  }
                  else if(t1.getText().equals("admin") && t2.getText().equals("admin1234"))
                  {
                  ...
                  {                      
                        JOptionPane.showMessageDialog(Frame2.this,"USERID OR WRONG IS WRONG","ALERT",JOptionPane.ERROR_MESSAGE);  
                        return;                    
                  }
            }
      });  
...
class Frame3 extends JFrame
{
      ...
      b2.addActionListener(new ActionListener()
      {
            public void actionPerformed(ActionEvent ae)
            {
                  if(t1.getText().equals(""))   
                  {
          			JOptionPane.showMessageDialog(Frame3.this,"Please Enter FIRST NAME","ALERT",JOptionPane.PLAIN_MESSAGE); 
                        return;
                  }
		      else if(t2.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame3.this,"Please Enter LAST NAME","ALERT",JOptionPane.PLAIN_MESSAGE);
                  }
                  else if(t5.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame3.this,"Please Enter GENDER","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
		      else if(t3.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame3.this,"Please Enter DEPARTMENT","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
		      else if(t4.getText().equals(""))
 		      {
			      JOptionPane.showMessageDialog(Frame3.this,"Please Enter ADDRESS","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
                  else
                  {   
...
class Frame4 extends JFrame
{
      ...
      b2.addActionListener(new ActionListener()
      {
            public void actionPerformed(ActionEvent ae)
            {
                  if(t1.getText().equals(""))   
                  {
          			JOptionPane.showMessageDialog(Frame4.this,"Please Enter SSC PERCENTAGE","ALERT",JOptionPane.PLAIN_MESSAGE); 
                        return;
                  }
		      else if(t2.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame4.this,"Please Enter HSC MARKS","ALERT",JOptionPane.PLAIN_MESSAGE);
                  }
                  else if(t5.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame4.this,"Please Enter AVERAGE POINTER","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
		      else if(t3.getText().equals(""))
		      {
			      JOptionPane.showMessageDialog(Frame4.this,"Please Enter COMMITTE NAME","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
		      else if(t4.getText().equals(""))
 		      {
			      JOptionPane.showMessageDialog(Frame4.this,"Please Enter NTEPL COURSE","ALERT",JOptionPane.PLAIN_MESSAGE);
		      }
                  else
                  {   
